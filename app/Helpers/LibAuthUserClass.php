...
class LibAuthUserClass
{
    ...
    public function getGroupsInfo()
    {
        ...
        foreach ($this->getAttribute('groupInfo') as $group) {
            ...
            $groupInfo[]=array('groupID'=>$subArray['group_id'],'groupName'=>$subArray['group_name']);
        }
        return $groupInfo;
    }
    ...
    public function getGroupName($idGroup)
    {
        foreach ($this->getGroupsInfo() as $group) {
            if($group['groupID'] == $idGroup){ return $group['groupName'];}
        }
        return "";
    }
    ...
    public function getPermissions()
    {
        ...
        if($app && array_key_exists('permissions',$app)){ return json_decode($app['permissions']); }
        return  false;
    }
